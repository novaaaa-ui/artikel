...
<!-- <article class="py-8 max-x-screen-md">
    ...
    <a href="/posts/" class="font-medium text-blue-700 hover:underline">&laquo; Back to posts</a>
</article> -->
                  ...
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <div>
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span>Waktu baca: {{ $post->readingTime() }}</span>
                        </div>
